...
* [BitSCADA](https://github.com/larionovavi-stack/bitscada) Industrial SCADA/HMI system in a single HTML file with full IEC 61850 (MMS/GOOSE/SV), OPC UA, Modbus TCP support. Zero installation, runs in any browser. [Demo](https://larionovavi-stack.github.io/bitscada/)
